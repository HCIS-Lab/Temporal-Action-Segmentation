...
_C.TEST.CHECKPOINT_PATH = "./experiments"
...
_C.MODEL.MASK_LOSS_FRACTION = 0.5

# _C.MODEL.BCE_WEIGHT = 0.0

# mse loss clamp/clip value
_C.MODEL.MSE_LOSS_CLIP_VAL = 16.0


_C.MODEL.ACTION_MASK = False
_C.MODEL.ACTION_SLOT = 0
_C.MODEL.PROGRESS_SLOT = 0
...
# Number of slots
_C.MODEL.TCN.ACTION_SLOT = 0

_C.MODEL.TCN.PROGRESS_SLOT = 0
